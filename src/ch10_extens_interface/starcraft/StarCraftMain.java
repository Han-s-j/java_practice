...
public class StarCraftMain {
	...
	public static void main(String[] args) {
		...
		Marine marine01 = new Marine();		//셋팅
		Marine marine02 = new Marine("영웅마린", 8, 100, 0);	//원하는 값 넣기
		System.out.println(marine01);
		System.out.println(marine02);
		
		marine01.move(100, 200);	//부모 기능
		marine02.stimpack();		//자식 기능
		System.out.println(marine02);
		
		/* 다형성(Polymorphism)
		 * 객체 저향 프로그래밍(OOP)의 핵심 개념 중 하나로
		...
		StarUnit highTemplar03 = highTemplar02; //자식에서 -> 부모 객체로 될 때 자동 형변환 됨.
		...
		//타입이 부모타입이기 때문에 부모가 가지고 있지 않은 메소드 사용불가
		...
		System.out.println(scv instanceof Zealot); // false 부모객체는 자식객체로 형변환 할 수 없음
